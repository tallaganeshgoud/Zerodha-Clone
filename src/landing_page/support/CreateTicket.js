    ...
    return ( 
        <div className='container'>
            <div className='row p-5 mt-5 mb-5'>
                ...
                <div className='col-4 p-5 mt-3 mb-2'>
                ...
                <div className='col-4 p-5 mt-3 mb-2'>
                    <h4><i class="fa fa-search" aria-hidden="true"></i> Console</h4>
                    ...
                    <a href='' style={{textDecoration:"none",lineHeight:"2.5"}}></a>Referral program<br/>
                </div>
                <div className='col-4 p-5 mt-3 mb-2'>
                    <h4><i class="fa fa-circle-o" aria-hidden="true"></i> Coin</h4>
